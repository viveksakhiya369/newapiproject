...
<?php
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
    <?php echo Html::submitButton("Search", ['class' => 'btn btn-primary', 'id' => 'submit-karigar']); ?>
    </div>
    <?php if(in_array(Yii::$app->user->identity->role_id,[User::DEALER])) { ?>
        <div class="col-lg-3 col-md-6 col-sm-6 ml-0">
        <?php echo Html::a("Create",['karigar/create'], ['class' => 'btn btn-primary', 'id' => 'submit-karigar']); ?>
        </div>
    <?php } ?>
