...
/**
 * This is the model class for table "karigar".
 *
 * @property int $id
 * @property int $user_id
 * @property int $parent_id dealer_id
 ...
 */
class Karigar extends \yii\db\ActiveRecord
{
    ...
    public function getDealer(){
        return $this->hasOne(Dealer::className(),['id'=>'parent_id']);
    }
}
